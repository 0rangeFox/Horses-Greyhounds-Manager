...
public class HorseMatchView : MatchView<Horse> {
    ...
    protected override Horse? JoinedAnimal => this.Match.Animals.FirstOrDefault(matchHorse => this.Team.Horses.Any(horse => horse.Status == Status.Racing && matchHorse == horse));
